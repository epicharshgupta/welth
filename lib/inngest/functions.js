...
// ---------------------------------------------------------
// MONTHLY REPORT + AI INSIGHTS (FIXED)
// ---------------------------------------------------------
export const generateMonthlyReports = inngest.createFunction(
  {
    id: "generate-monthly-reports",
...
// ---------------------------------------------------------
// FIXED AI INSIGHTS (NO ERROR ANYMORE)
// ---------------------------------------------------------
async function generateFinancialInsights(stats, month) {
  ...
  const prompt = `
    Analyze these numbers and generate 3 short insights.
    Total Income: ${stats.totalIncome}
    Total Expenses: ${stats.totalExpenses}
    Category Breakdown: ${JSON.stringify(stats.byCategory)}
  ...
  try {
    ...
    return [
      "Your top expense category increased significantly.",
      "Try allocating a monthly budget to control spending.",
      "Track subscriptions and recurring expenses to reduce waste.",
    ];
  }
}
